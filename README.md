...
```
![](https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fkckrlrcikotbzc1hghff.png)
## LevelDB
```js
const Automerge = require('automerge');
const Hyperswarm = require('hyperswarm');
